...
export class TokensAccountsStorage extends StorageBase {
     ...
     */
    get isV3(): boolean {
        return this.getTypeHash() === 'f741d87278aef397443c05fd06e3d212341910447aa8cc33f1f219cdc1eb052a'
    }
     ...
     */
    get isV8(): boolean {
        return this.getTypeHash() === 'b2f34ee2eebc590b20341e2bf6215c062b445e466e84386b570e270645bb7d51'
    }
...
export interface TokensAccountsStorageV3 {
    ...
    getKeys(key1: Uint8Array, key2: v3.CurrencyId): Promise<[Uint8Array, v3.CurrencyId][]>
    getKeysPaged(pageSize: number): AsyncIterable<[Uint8Array, v3.CurrencyId][]>
    getKeysPaged(pageSize: number, key1: Uint8Array): AsyncIterable<[Uint8Array, v3.CurrencyId][]>
    getKeysPaged(pageSize: number, key1: Uint8Array, key2: v3.CurrencyId): AsyncIterable<[Uint8Array, v3.CurrencyId][]>
    getPairs(): Promise<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
    getPairs(key1: Uint8Array): Promise<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
    getPairs(key1: Uint8Array, key2: v3.CurrencyId): Promise<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
    getPairsPaged(pageSize: number, key1: Uint8Array): AsyncIterable<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
    getPairsPaged(pageSize: number, key1: Uint8Array, key2: v3.CurrencyId): AsyncIterable<[k: [Uint8Array, v3.CurrencyId], v: v3.Type_360][]>
}
...
export interface TokensAccountsStorageV8 {
    ...
    getKeys(key1: Uint8Array, key2: v8.CurrencyId): Promise<[Uint8Array, v8.CurrencyId][]>
    getKeysPaged(pageSize: number): AsyncIterable<[Uint8Array, v8.CurrencyId][]>
    getKeysPaged(pageSize: number, key1: Uint8Array): AsyncIterable<[Uint8Array, v8.CurrencyId][]>
    getKeysPaged(pageSize: number, key1: Uint8Array, key2: v8.CurrencyId): AsyncIterable<[Uint8Array, v8.CurrencyId][]>
    getPairs(): Promise<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
    getPairs(key1: Uint8Array): Promise<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
    getPairs(key1: Uint8Array, key2: v8.CurrencyId): Promise<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
    getPairsPaged(pageSize: number, key1: Uint8Array): AsyncIterable<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
    getPairsPaged(pageSize: number, key1: Uint8Array, key2: v8.CurrencyId): AsyncIterable<[k: [Uint8Array, v8.CurrencyId], v: v8.Type_452][]>
}
...
export class TokensTotalIssuanceStorage extends StorageBase {
     ...
     */
    get isV3(): boolean {
        return this.getTypeHash() === '3180077969081921b1f1260f6696684789757f8c0b6adc91a41e6029dfe49428'
    }
     ...
     */
    get isV8(): boolean {
        return this.getTypeHash() === 'cdfa53f72a693e3be9f1b744ea79875ce4fe38d67a7fbf3b2b11e88d72354ff9'
    }
...
export interface TokensTotalIssuanceStorageV3 {
    ...
    getKeysPaged(pageSize: number, key: v3.CurrencyId): AsyncIterable<v3.CurrencyId[]>
    getPairs(): Promise<[k: v3.CurrencyId, v: bigint][]>
    getPairs(key: v3.CurrencyId): Promise<[k: v3.CurrencyId, v: bigint][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: v3.CurrencyId, v: bigint][]>
    getPairsPaged(pageSize: number, key: v3.CurrencyId): AsyncIterable<[k: v3.CurrencyId, v: bigint][]>
}
...
export interface TokensTotalIssuanceStorageV8 {
    ...
    getKeysPaged(pageSize: number, key: v8.CurrencyId): AsyncIterable<v8.CurrencyId[]>
    getPairs(): Promise<[k: v8.CurrencyId, v: bigint][]>
    getPairs(key: v8.CurrencyId): Promise<[k: v8.CurrencyId, v: bigint][]>
    getPairsPaged(pageSize: number): AsyncIterable<[k: v8.CurrencyId, v: bigint][]>
    getPairsPaged(pageSize: number, key: v8.CurrencyId): AsyncIterable<[k: v8.CurrencyId, v: bigint][]>
}

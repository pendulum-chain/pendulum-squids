...
export async function handleTokenDeposited(
    ctx: EventHandlerContext,
...
export async function handleTokenWithdrawn(
    ctx: EventHandlerContext,
    type: TOKEN_EVENT_TYPE
) {
    const transactionHash = ctx.event.extrinsic?.hash

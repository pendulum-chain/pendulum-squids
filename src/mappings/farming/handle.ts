...
export async function handleFarmingAllForceGaugeClaimed(
...
export async function handleFarmingPartiallyForceGaugeClaimed(
    ctx: EventHandlerContext
) {
...
export async function handleSyncFamingPoolInfo(
    ctx: EventHandlerContext,
    pid: number
) {

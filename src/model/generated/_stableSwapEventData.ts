...
export type StableSwapEventData =
...
export function fromJsonStableSwapEventData(json: any): StableSwapEventData {
    switch (json?.isTypeOf) {
        case 'StableSwapNewFeeEventData':
            return new StableSwapNewFeeEventData(undefined, json)
        case 'StableSwapRampAEventData':
            return new StableSwapRampAEventData(undefined, json)
        case 'StableSwapStopRampAEventData':
            return new StableSwapStopRampAEventData(undefined, json)
        case 'StableSwapAddLiquidityEventData':
            return new StableSwapAddLiquidityEventData(undefined, json)
        case 'StableSwapRemoveLiquidityEventData':
            return new StableSwapRemoveLiquidityEventData(undefined, json)
        case 'StableSwapFlashLoanEventData':
            return new StableSwapFlashLoanEventData(undefined, json)
        default:
            throw new TypeError(
                'Unknown json object passed as StableSwapEventData'
            )
    }
}

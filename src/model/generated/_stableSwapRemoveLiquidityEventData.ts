...
export class StableSwapRemoveLiquidityEventData {
    ...
    constructor(
        props?: Partial<Omit<StableSwapRemoveLiquidityEventData, 'toJSON'>>,
        json?: any
    ) {
        ...
        if (json != null) {
            ...
            this._fees =
                json.fees == null
                    ? undefined
                    : marshal.fromList(json.fees, (val) =>
                          marshal.bigint.fromJSON(val)
                      )
            this._lpTokenSupply =
                json.lpTokenSupply == null
                    ? undefined
                    : marshal.bigint.fromJSON(json.lpTokenSupply)
        }
    }
    ...
    toJSON(): object {
        return {
            ...
            fees:
                this.fees == null
                    ? undefined
                    : this.fees.map((val: any) => marshal.bigint.toJSON(val)),
            lpTokenSupply:
                this.lpTokenSupply == null
                    ? undefined
                    : marshal.bigint.toJSON(this.lpTokenSupply),
        }
    }
}

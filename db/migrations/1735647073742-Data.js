module.exports = class Data1735647073742 {
    name = 'Data1735647073742'
    ...
    async up(db) {
        ...
        await db.query(
            `CREATE TABLE "points" ("id" character varying NOT NULL, "points_swap" text NOT NULL, "points_lp_swap" text NOT NULL, "points_lp_backstop" text NOT NULL, CONSTRAINT "PK_57a558e5e1e17668324b165dadf" PRIMARY KEY ("id"))`
        )
        await db.query(
        ...
        await db.query(
            `CREATE TABLE "redeem_request" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "opentime" numeric NOT NULL, "period" numeric NOT NULL, "redeemer" text NOT NULL, "amount" numeric NOT NULL, "asset" text NOT NULL, "fee" numeric NOT NULL, "premium" numeric NOT NULL, "transfer_fee" numeric NOT NULL, "status" character varying(17) NOT NULL, "stellar_address" text NOT NULL, "vault_id" character varying, CONSTRAINT "PK_cfc413a4a56777d07b29de675fa" PRIMARY KEY ("id"))`
        )
        await db.query(
